...
(custom environments can be build by editing angular-cli.json, did not build this yet)


# [Electron server and build]

3. run `npm run electron` or `npm run build.electron`.


using `gulp-html` for fixing paths generated by angular-cli in index.html and for scripts in electron.js file

folders generated at electron/dist/dev for simple electron build.


# [Template ReadMe]

from this line -> readme copied from https://www.creative-tim.com/product/material-dashboard-angular2/ project, give credit to this guys.
